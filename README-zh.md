...
> 这是一个极简的基于vue-admin-template的 vue admin 管理后台。它包含了 Element UI & axios & iconfont & permission control & lint 等等，这些搭建后台必要的东西。

[vue-admin-template 线上地址](http://panjiachen.github.io/vue-admin-template)
